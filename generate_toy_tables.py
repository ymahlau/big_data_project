...
def main():
    ...
    for class_ in CLASSES:
        ...
        master.to_csv(f"toy_tables/master/{class_}.csv", index=False, sep=";")
...
if __name__ == "__main__":
    ...
    if not os.path.exists("toy_tables"):
        os.makedirs("toy_tables")
    if not os.path.exists("toy_tables/master"):
        os.makedirs("toy_tables/master")
